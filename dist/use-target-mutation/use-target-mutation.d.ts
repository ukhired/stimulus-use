...
export declare const useTargetMutation: (controller: TargetMutationComposableController, options?: TargetMutationOptions) => (() => void)[];
//# sourceMappingURL=use-target-mutation.d.ts.map